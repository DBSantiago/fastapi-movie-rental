...
from api.apps.films.models import FilmCategoryModel
from api.apps.films.schemas import FilmCategoryRequest, FilmCategoryResponse
...
router = APIRouter(
    prefix="/categories",
    tags=["film categories"],
)

_model = FilmCategoryModel
_request_schema = FilmCategoryRequest
_response_schema = FilmCategoryResponse
