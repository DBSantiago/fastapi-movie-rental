...
from api.apps.films.schemas import FilmRequest, FilmResponse
from api.apps.films.services import FilmResponseManager
...
_model = FilmModel
_request_schema = FilmRequest
_response_schema = FilmResponse
_service = FilmResponseManager
