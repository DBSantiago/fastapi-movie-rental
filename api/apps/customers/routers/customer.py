...
from api.apps.customers.schemas import CustomerRequest, CustomerResponse
from api.apps.customers.services import CustomerResponseManager
...
_request_schema = CustomerRequest
_response_schema = CustomerResponse
_service = CustomerResponseManager
