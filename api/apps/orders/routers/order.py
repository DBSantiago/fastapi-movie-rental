...
from api.apps.orders.schemas import OrderRequest, OrderResponse
from api.apps.orders.services import OrderResponseManager
...
_model = OrderModel
_request_schema = OrderRequest
_response_schema = OrderResponse
_service = OrderResponseManager
