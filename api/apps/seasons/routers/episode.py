...
from api.apps.seasons.models import EpisodeModel
from api.apps.seasons.schemas import EpisodeRequest, EpisodeResponse
...
_model = EpisodeModel
_request_schema = EpisodeRequest
_response_schema = EpisodeResponse
