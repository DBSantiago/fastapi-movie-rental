...
from api.apps.cast.schemas import MemberRequest, MemberResponse
from api.apps.cast.services.cast_response import CastResponseManager
...
_model = MemberModel
_request_schema = MemberRequest
_response_schema = MemberResponse
_service = CastResponseManager
