...
from api.apps.cast.models import GenderModel
from api.apps.cast.schemas import GenderRequest, GenderResponse
...
_model = GenderModel
_request_schema = GenderRequest
_response_schema = GenderResponse
