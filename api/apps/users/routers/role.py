...
from api.apps.users.models import UserRoleModel
from api.apps.users.schemas import UserRoleRequest, UserRoleResponse
from api.apps.users.services import UserRoleResponseManager
...
_model = UserRoleModel
_request_schema = UserRoleRequest
_response_schema = UserRoleResponse
_service = UserRoleResponseManager
