...
from api.apps.users.schemas import UserRequest, UserResponse
from api.apps.users.services import UserResponseManager
...
_model = UserModel
_request_schema = UserRequest
_response_schema = UserResponse
_service = UserResponseManager
